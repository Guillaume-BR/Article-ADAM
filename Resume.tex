...
L'article \og ADAM: A method for Stochastic Optimization \cite{kingma2017adammethodstochasticoptimization}\fg{} a été publié en 2014 (et corrigé jusqu'en 2017) par Diederik P. Kingma (Université d'Amsterdam, OpenAI) et Jimmy Lei Ba (Université de Toronto) dans le cadre de l'International Conference on Learning Representations (ICLR) de 2015. 
...
On trouve une idée similaire dans les algorithmes AdaGrad (mais sans moyenne mobile) et RMSProp. 
